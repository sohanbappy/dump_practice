...
//    private static final long CUSTOM_EPOCH = 1577836800000L;
    private static final long CUSTOM_EPOCH = 2394426645L;
    ...
    public synchronized long nextId(long epoch) {
        long currentTimestamp = timestamp(epoch);
    ...
    private static long timestamp(long epoch) {
